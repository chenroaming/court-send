            ...
            <div v-if="infoMol">
                <Tabs  @on-click="changeTab" >
                    ...
                    <TabPane label="要素信息" v-if="element != 0 ">
                        <elementInfo ref="elementInfo" v-if="elementSw" :lawcaseId="lawcaseId" :element="element"></elementInfo>
                    </TabPane>
                    <!-- <TabPane label="审查意见">
...
import elementInfo from "@/components/element/elementInfo.vue";
export default {
  components: {
        ClipLoader,
